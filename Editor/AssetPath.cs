...
namespace CodeSmile.Editor
{
	...
	public partial class AssetPath : IEquatable<AssetPath>, IEquatable<String>
	{
		...
		/// </summary>
		public AssetPath UniqueFilePath => UniquifyFilename(this);
		...
		/// </summary>
		public AssetPath FolderPathAssumptive
		{
			get
			{
				// existing directory? return that
		...
		private AssetPath ToFolderPath() => new(Path.GetDirectoryName(m_RelativePath));
