...
For best performance, prefer to use Code\+Smile\+Editor.\+Asset.\+File.\+Import(\+String\mbox{[}$\,$\mbox{]},\+Import\+Asset\+Options) to import multiple assets in a batch operation. 
...
\begin{DoxyItemize}
\item Code\+Smile\+Editor.\+Asset.\+File.\+Import(\+String\mbox{[}$\,$\mbox{]},\+Import\+Asset\+Options)
